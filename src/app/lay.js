...
function LayoutWithRedux({ children }) {
  ...
  React.useEffect(() => {
  const publicPaths = ['/login', '/signup', '/resetpassword', '/', '/domestic-holidays', '/international-holidays', '/activity', '/visa-query', '/backup/international-holidays'];
  ...
  const navItems = [
    ...
    { label: 'Bookings', href: '/admin/bookings', icon: '🗂️' },
    {
      ...
      icon: '🏖️',
      submenu: [
        { label: 'All Packages', href: '/admin/package' },
        { label: 'Add Package', href: '/admin/package?entity=package' },
        { label: 'Categories', href: '/admin/package?entity=packageCategory' },
      ]
    },
